...
/* DDL Role: Grant default privileges to apply to future created objects. */
ALTER DEFAULT PRIVILEGES IN SCHEMA ${appfunc}_schema
    GRANT TRUNCATE, SELECT, INSERT, UPDATE, DELETE ON TABLES TO
...
ALTER DEFAULT PRIVILEGES IN SCHEMA ${appfunc}_schema
    GRANT USAGE, SELECT ON SEQUENCES TO wf_${appname}_pg_app_ddl_role;
...
/* DML Role: Grant default privileges to apply to future created objects. */
ALTER DEFAULT PRIVILEGES IN SCHEMA ${appfunc}_schema
...
/* DQL Role: Drant default privileges to apply to future created objects. */
ALTER DEFAULT PRIVILEGES IN SCHEMA ${appfunc}_schema
